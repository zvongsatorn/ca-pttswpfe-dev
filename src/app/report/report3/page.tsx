...
export default function Report3Page() {
    ...
    useEffect(() => {
        void fetchFilterOptions(dateValue, selectedBusinessUnit, selectedLineOfWork);
    }, [dateValue, selectedBusinessUnit, selectedLineOfWork, fetchFilterOptions]);
    ...
    const onSearch = async (values: SearchFormValues) => {
        ...
        await fetchReportData(nextDate, bgNo, division, orgUnitNo);
    };
    ...
    const filteredData = useMemo(() => {
        ...
        const selectedBg = businessUnits[0] || '';
        const selectedLine = linesOfWork[0] || '';
        const selectedUnit = orgUnits[0] || '';
        ...
        return allData.filter((item) => {
            ...
            const isBgMatch = !selectedBg || item._bgNo === selectedBg;
            const isLineMatch = !selectedLine || item.line_of_work === selectedLine;
            const isUnitMatch = !selectedUnit || item.unit_code === selectedUnit;
            return (
