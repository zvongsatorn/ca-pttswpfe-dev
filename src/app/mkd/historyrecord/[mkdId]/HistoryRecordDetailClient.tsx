...
export default function HistoryRecordDetailClient({ mkdId, token, currentUser, initialData, masterKeys }: HistoryRecordDetailClientProps) {
    ...
    const handleExportExcel = async () => {
        try {
            ...
            await saveExcelFile(blob, `MKD_Record_${header.RequestNo}_${dayjs().format('YYYYMMDD')}.xlsx`);
        } catch {
                                        ...
                                        return (
                                            <TableRow key={idx} className="hover:bg-slate-50/50">
                                                ...
                                                <TableCell className="border-l text-center">
                                                    <Button variant="ghost" className="h-auto p-2 hover:bg-blue-50 flex flex-col items-center justify-center space-y-1 mx-auto" onClick={() => openSafeApiPath(buildFilesProxyPath(header.EffectiveYear, file.FileUpload))}>
