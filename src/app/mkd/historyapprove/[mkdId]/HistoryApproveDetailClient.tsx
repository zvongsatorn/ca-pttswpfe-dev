...
export default function HistoryApproveDetailClient({ mkdId, token, currentUser, initialData, masterKeys }: HistoryApproveDetailClientProps) {
    ...
    // For Approve view, maybe they can't edit. Assuming Read-only for legacy table mapping
            ...
            <Card className="bg-linear-to-r from-blue-600 to-blue-700 border-0 shadow-lg py-2">
                <CardContent>
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-white bg-green-500/20 px-3 py-1 rounded-full text-sm font-medium border border-green-400/30 backdrop-blur-sm shadow-sm inline-flex items-center gap-2">
                                            ...
                                            <TableRow className="bg-blue-50/20 hover:bg-blue-50/40 border-t-2 border-t-slate-100">
                                                <TableCell className="p-2 text-center">
                                                    {driver.type === 'Index' && !isReadOnly && (
                                                        <Button size="icon" variant="ghost" className="h-6 w-6 text-green-600 rounded-full hover:bg-green-100" title="เพิ่มรายการย่อย">
                                                ...
                                                <TableCell className="p-2 text-center border-l border-slate-100">
                                                    {!isReadOnly && <Button size="icon" variant="ghost" className="h-6 w-6 text-blue-500"><Edit className="w-3.5 h-3.5" /></Button>}
                                                </TableCell>
                                                <TableCell className="p-2 text-center">
                                                    {!isReadOnly && <Button size="icon" variant="ghost" className="h-6 w-6 text-red-500"><Trash2 className="w-3.5 h-3.5" /></Button>}
                                                </TableCell>
                                            </TableRow>
